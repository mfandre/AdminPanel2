...
{
    public class ActionColumnItem : ColumnItem
    {
        private string ButtonText;
        public string Url { get; set; }
        public string ActionColumnItemId { get; set; }
        ...
        public ActionColumnItem(string ActionColumnItemId, string ColData, string ColName, string ButtonText, string Url, int Width = -1)
            : base(ColData, ColName, false, true, ColumnType.String,Width)
        {
            this.ActionColumnItemId = ActionColumnItemId;
        ...
        public override string ToString()
        {
            ...
            code += "                       $(nTd).html(\"<a data-id='\"+sData+\"' class='btn btn-default btn-xs " + ActionColumnItemId + "'><i class='fa fa-gear fa-lg'></i> " + ButtonText + "</a>\");\n";
            code += "                   }\n";
            code += "               }";
            return code;
        }    
